...
interface ProFeaturesViewProps {
  history: BudgetData[];
...
export const ProFeaturesView: React.FC<ProFeaturesViewProps> = ({ 
  history, 
  currencySymbol, 
  notificationCount, 
            ...
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <h1 className="text-2xl font-bold leading-none tracking-tight text-slate-900 dark:text-white flex items-center gap-2">
                        PRO Features <Bot className="text-indigo-600 dark:text-indigo-400 h-6 w-6" />
                    </h1>
                </div>
